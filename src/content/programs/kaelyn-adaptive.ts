...
export const kaelynAdaptive: Program = {
  ...
  units: [
...

    {
      id: "word-baseline",
      order: 0,
      title: "Word Study — Show what you know",
      emoji: "🌟",
      world: "ocean",
      bigIdea: "Let's see what you already know about words — there's no wrong here.",
      phonicsFocus: "A quick, friendly check-in",
      mathFocus: "",
      project: "Just build and tap — I'm watching what you've got.",
      checkpoint: "baseline",
      lessons: [
        {
          id: "word-baseline-l1",
          ...
          activities: [
            {
              ...
              config: {
                focus: "the six syllable types (closed, open, silent-e, vowel team, r-controlled, consonant-le)",
                instruction: "Build each word from its syllable tiles, then say whether the vowel is short or long.",
                tiles: ["rab", "bit", "ta", "ble"],
                // Isolated misreads: ta→"tah" (want long-A), ble→"blee" (want
                // schwa consonant-le). rab/bit already voice correctly.
                say: { ta: "tˈA", ble: "bəl" },
                words: [{ word: "rabbit" }, { word: "table" }],
              },
            },
            {
              id: "word-baseline-a2",
              kind: "phonics-wordbuild",
              title: "Chop it and read it",
              blurb: "Read each syllable, then blend the whole word.",
              estMinutes: 6,
              band: "ready",
              skillTags: ["word.syllables.division"],
              config: {
                focus: "dividing multisyllable words (VC/CV, V/CV, C+le)",
                instruction: "This word is split into syllables. Read each part, then blend it into the whole word.",
                tiles: ["ad", "ven", "ture"],
                // Isolated misread: ture→"tyoor" (want "cher"); rest read fine.
                say: { ture: "ʧəɹ" },
                words: [{ word: "adventure" }],
              },
            },
            {
              id: "word-baseline-a3",
              ...
              config: {
                focus: "prefixes that change meaning (un-, re-, pre-, dis-, mis-, non-)",
                instruction: "Snap a prefix onto each base word. Read what you made, then say what the prefix did to the meaning.",
                tiles: ["un", "re", "happy", "play"],
                // "re" alone reads "ray"; in "replay" it's "ree".
                say: { re: "ɹˈi" },
                words: [{ word: "unhappy" }, { word: "replay" }],
              },
            },
            {
              id: "word-baseline-a4",
              ...
              skillTags: ["word.morphology.roots"],
              config: {
                focus: "Greek and Latin roots (tele = far, graph = write, geo = earth)",
                instruction: "Each tile is a root that carries meaning. Build the word, read it, then reason out what it means from its parts.",
                // "y" completes the -y suffix in geography (geo+graph+y); the
                // lone "y" misreads as "why" — pin it to /i/. Roots read fine.
                tiles: ["tele", "graph", "geo", "y"],
                say: { y: "i" },
                words: [{ word: "telegraph" }, { word: "geography" }],
              },
            },
            {
              id: "word-baseline-a5",
              kind: "sightword-game",
              title: "Tap the synonym",
              blurb: "Which words mean almost the same as happy?",
              estMinutes: 5,
              band: "ready",
              skillTags: ["vocab.shades-of-meaning"],
              config: {
                instruction: "Tap every word that means almost the same as \"happy.\" Leave the opposites alone.",
                words: ["glad", "cheerful", "joyful"],
                decoys: ["sad", "upset", "grumpy"],
              },
            },
          ],
        },
