          ...
          config: {
            ...
            structuredRetell: {
              ...
              events: [
                ...
                { id: "erupt", text: "The volcano erupts." },
                { id: "lava", text: "Lava runs down the side." },
              ],
            },
          },
        },
          ...
          config: {
            ...
            questions: [
              ...
              },
              {
                ...
                answerIndex: 1,
                kind: "literal",
                evidenceSentenceIndexes: [3, 4],
              },
            ],
            structuredRetell: {
              prompt: "Put the story events in order, then retell what happened.",
              events: [
                { id: "enter", text: "Jack and Annie enter the tomb." },
                { id: "follow", text: "They follow the painted birds." },
                { id: "escape", text: "They find the way outside." },
              ],
            },
          },
        },
