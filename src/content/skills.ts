...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    readyIndicator: "Names characters, setting, problem, and solution, and retells a story in order keeping the key events",
  ...
  },
  {
    ...
    readyIndicator: "States what a passage is mostly about in one sentence and picks key details that support it, telling important from interesting",
  ...
  // ── Vocabulary depth (strands/word-study-vocabulary.md, R-WS-12..R-WS-15) ──
  {
    ...
    readyIndicator: "Gives a synonym and an antonym and orders near-synonyms by degree (happy → glad → thrilled)",
  ...
  // ── Math (strands/math.md, R-MA-1..R-MA-11) ──
  {
    ...
    readyIndicator: "Builds equal groups or an array and finds the total by skip-counting, describing it as \"__ groups of __\"",
  ...
  },
  {
    ...
    readyIndicator: "Represents a fact within 10 with a model and its equation, reads it aloud, and finds the product (building or skip-counting allowed)",
  ...
  },
  {
    ...
    readyIndicator: "Solves a division situation by sharing or grouping and writes the full ×/÷ fact family for a given fact",
  ...
  },
  {
    ...
    domain: "math",
    label: "Geometry: attributes, partitioning, area as arrays",
    readyIndicator: "Names/sorts 2D and 3D shapes by attributes, partitions a shape into equal parts more than one way, and finds area by arraying unit squares",
