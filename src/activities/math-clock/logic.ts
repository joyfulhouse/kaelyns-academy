...
/** The child's response: which time they selected or set. */
export interface MathClockResponse {
  attempts: number;
  /** read mode: index of the choice the child tapped. */
  selectedIndex?: number;
  /** set mode: the hour and minute the child set the clock to. */
  setHour?: number;
  setMinute?: number;
}
...
/** read or set → always the time skill. */
