...
describe("isCorrect", () => {
  it("identify matches the target coin", () => {
    const c: MathMoneyConfig = { mode: "identify", instruction: "", coins: ["penny","dime"], targetCoin: "dime" };
  ...
  it("count matches the target total", () => {
    const c: MathMoneyConfig = { mode: "count", instruction: "", palette: ["nickel","penny"], targetCents: 12 };
...
describe("score", () => {
  const c: MathMoneyConfig = { mode: "count", instruction: "", palette: ["penny"], targetCents: 3 };
