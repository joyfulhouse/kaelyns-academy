      ...
      <div className="mx-auto grid w-full max-w-2xl gap-4 sm:grid-cols-2 md:grid-cols-4">
        {parsed.bins.map((bin) => (
          <motion.button
            ...
            className={cn(
              "grid min-h-11 place-items-center gap-2 rounded-2xl border-[3px] border-dashed border-ink/40 bg-paper-sunk px-4 py-6 text-ink transition duration-200 ease-out",
              "disabled:opacity-50",
